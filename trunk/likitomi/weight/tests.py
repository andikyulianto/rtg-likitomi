...
class AssignTagTestCase(unittest.TestCase):
	...
	def testNewTag(self):
		self.client.get('/minclamp/assigntag/', {'atagid': 2, 'apcode': 'CA125', 'asize': 36, 'aweight': 800, 'alane': 'B', 'aposition': 2, 'atag2write': '112233445566778899AABBCC'})
	...
	def testReuseTag(self):
		self.client.get('/minclamp/assigntag/', {'atagid': 2, 'apcode': 'CA125', 'asize': 36, 'aweight': 800, 'alane': 'B', 'aposition': 2, 'atag2write': '30001AAAA000000000000000'})
		self.assertEqual(PaperRoll.objects.filter(id=2).exists(), True)
	...
	def testUpdateTag(self):
		self.client.get('/minclamp/assigntag/', {'atagid': 1, 'apcode': 'CA125', 'asize': 36, 'aweight': 800, 'alane': 'B', 'aposition': 2, 'atag2write': '30001AAAA000000000000000'})
