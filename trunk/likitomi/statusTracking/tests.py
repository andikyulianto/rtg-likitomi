...
#		gu.save()
	...
	def test_process_15405(self):
		self.st = StatusTracking.objects.get(plan_id=15559)
		self.assertEqual(self.st.process1(),"CR")
		self.assertEqual(self.st.process2(),"WH")
		self.assertEqual(self.st.process3(),NULL)
		self.assertEqual(self.st.process4(),NULL)
