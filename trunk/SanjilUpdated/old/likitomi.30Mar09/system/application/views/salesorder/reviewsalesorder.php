...
<div id='boxcontainer'>
	<table width='100%'>
		<tr>
			...
			<td class='tblDetailView'><?=$resultSales->sales_order_date;?></td>
...
{ ?>
	<tr>
		...
		<td class='tblProdView'><span onclick='inlineEditSales(this,"amount_1");'><?=$resultSales->amount_1?>
			<input type='hidden' value='<?=$resultSales->amount_1?>' id='xh_amount1' /></span></td>
	</tr>
<?php }
?>	
<?php 
...
{ ?>
	<tr>
		...
		<td class='tblProdView'><span onclick='inlineEditSales(this,"amount_2");'><?=$resultSales->amount_2?>
			<input type='hidden' value='<?=$resultSales->amount_2?>' id='xh_amount2' /></span></td>
	</tr>
<?php }
?>	
<?php 
...
{ ?>
	<tr>
		...
		<td class='tblProdView'><span onclick='inlineEditSales(this,"amount_3");'><?=$resultSales->amount_3?>
			<input type='hidden' value='<?=$resultSales->amount_3?>' id='xh_amount3' /></span></td>
	</tr>
<?php }
?>	
<?php 
...
{ ?>
	<tr>
		...
		<td class='tblProdView'><span onclick='inlineEditSales(this,"amount_4");'><?=$resultSales->amount_4?>
			<input type='hidden' value='<?=$resultSales->amount_4?>' id='xh_amount4' /></span></td>
	</tr>
<?php }
?>	
				</table>
...
<div id='boxcontainer'>
	<table width='100%'>
		<tr>
			...
			<td class='tblDetailView'> <span onclick='inlineEditSales(this,"purchase_order_no");'><?=$resultSales->purchase_order_no?></span></td>
			<td class='tblDetailViewLabel'>Remarks :</td>
			<td class='tblDetailView'> <span onclick='inlineEditSales(this,"remarks");'><?=$resultSales->remarks?></span></td>
		</tr>
	</table>
</div>
<br/>
...
?>
	<tr>
		...
		<td class='DeliveryView'><span onclick='inlinedit(this,3)'><?=$deliveryList->delivery_date?></span></td>
...
?>
	<tr>
		...
		<td class='tblProdView' onclick='sumAmount(this);'><img src='<?=base_url()."static/images/extjs/save.gif"?>'/></td>	
	</tr>
</table>
<br/>
