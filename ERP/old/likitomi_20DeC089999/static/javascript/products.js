		...
		Ext.Ajax.request({
			...
			success: function ( result, request ) { 
				...
				try {
					...
					cell.className	= 'tblProdView';
					cell.innerHTML 	= "<span onclick='inlinedit(this,3)'>"+Ext.get('x_delivery_date').dom.value+"</span>";
					...
					cell.setAttribute('onclick','deleteDelivery(this);');
