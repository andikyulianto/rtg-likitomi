...
//		$products['customer_part_no'] = ($this->input->post('customer_part_no'))?$this->input->post('customer_part_no'):'';
		...
		$products['req_gh'] = ($this->input->post('req_gh'))?$this->input->post('req_gh'):'';
		$products['req_rd'] = ($this->input->post('req_rd'))?$this->input->post('req_rd'):'';
		$products['req_wh'] = ($this->input->post('req_wh'))?$this->input->post('req_wh'):'';
		$products['req_3cm'] = ($this->input->post('req_3cm'))?$this->input->post('req_3cm'):'';
		$products['req_hs'] = ($this->input->post('req_hs'))?$this->input->post('req_hs'):'';
		$products['req_ss'] = ($this->input->post('req_ss'))?$this->input->post('req_ss'):'';
		$products['req_3cs'] = ($this->input->post('req_3cs'))?$this->input->post('req_3cs'):'';
		$products['req_fg'] = ($this->input->post('req_fg'))?$this->input->post('req_fg'):'';
		$products['req_remove'] = ($this->input->post('req_remove'))?$this->input->post('req_remove'):'';
		$products['req_4cd'] = ($this->input->post('req_4cd'))?$this->input->post('req_4cd'):'';
		$products['req_foam'] = ($this->input->post('req_foam'))?$this->input->post('req_foam'):'';
		$products['req_3cl'] = ($this->input->post('req_3cl'))?$this->input->post('req_3cl'):'';
		$products['req_tape'] = ($this->input->post('req_tape'))?$this->input->post('req_tape'):'';
